...
local my_on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', 'gdc', '<cmd>belowright split | lua vim.lsp.buf.declaration()<CR>', opts)
    buf_set_keymap('n', 'gdf', '<cmd>belowright split | lua vim.lsp.buf.definition()<CR>', opts)
